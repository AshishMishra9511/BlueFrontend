...
export default class BleModule{
    ...
    write(value,index){
        // let asciiValue = new Buffer(value, "base64").toString('ascii'); //Turn into ascii to send the past
        // let hexValue = new Buffer(value, "base64").toString('hex');  //Convert to hexadecimal data and send it to the past      
